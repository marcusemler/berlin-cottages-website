function makeHeader(currentPage) {
  ...
  return `
    ...
    <header class="site-header" id="site-header">
      <div class="nav-wrap">
        <a class="brand brand-inline" href="index.html" aria-label="Berlin Cottages home">
          <span class="brand-mark">Berlin Cottages</span>
        </a>
        ...
        <nav id="primary-nav" class="nav-links" aria-label="Primary">
          ${nav}
          <a class="button" href="https://book.amishcountrylodging.com/all-listings?category=20986" target="_blank" rel="noreferrer">Book Now</a>
        </nav>
      </div>
    </header>
  `;
  ...
  return `
    <footer class="site-footer">
      <div class="footer-inner">
        <div>
          <div class="brand-mark" style="color:var(--ink)">Berlin Cottages</div>
          <p style="color:var(--muted);margin:0.5rem 0 0">Downtown Berlin, Ohio &mdash; Amish Country lodging with direct booking.</p>
        </div>
        <ul class="footer-links">
          ...
          <li><a href="tel:13308931300">(330) 893-1300</a></li>
        </ul>
        <div class="kicker">Berlin Cottages &middot; 4895 West Main St., Berlin, OH 44610</div>
      </div>
    </footer>
  `;
}

function renderUnits(containerId) {
  ...
  container.innerHTML = units.map(unit => `
    <article class="unit-card reveal">
      <div class="unit-card__img-wrap">
        <img src="${unit.image}" alt="${unit.name} at Berlin Cottages" loading="lazy">
      </div>
...
function renderGallery(containerId, limit) {
  ...
  const list = typeof limit === "number" ? galleryItems.slice(0, limit) : galleryItems;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  renderFaqs("#faq-list");
  renderGallery("#gallery-preview", 6);
